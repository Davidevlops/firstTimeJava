public class Main {
  public static void main(String[] args) {
    ...
    double justARandomDoubleNumber = 12.77728d;
    char castedStringOfRandomCharacters = aSringOfRandomCharacters.charAt(1);
    ...
    System.out.println(castedStringOfRandomCharacters);
